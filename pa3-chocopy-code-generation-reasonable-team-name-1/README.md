...
See the [PA3 specification][PA3 specification] on the course
website for a detailed specification of the assignment.

Refer to the [ChocoPy Specification][ChocoPy Specification] on the CS164 web site
for the specification of the ChocoPy language.

Refer to the [ChocoPy Implementation Guide][ChocoPy Implementation Guide] on the CS164 web site
...
Team member 1: Pengfei Tian

Team member 2: Yifan Jiang
