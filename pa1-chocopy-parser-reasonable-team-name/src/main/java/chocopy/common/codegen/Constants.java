...
public class Constants {
    ...
    public Label fromLiteral(Literal literal) {
        return switch (literal) {
            case IntegerLiteral il -> getIntConstant(il.value);
            case StringLiteral sl -> getStrConstant(sl.value);
            case BooleanLiteral bl -> getBoolConstant(bl.value);
            case NoneLiteral _nl -> null;
            case null -> null;
        };
    }
}
